  ...
  return (
    <>
      ...
      >
        ...
        {/* Footer / CTA */}
        <div className={`p-margin-mobile flex flex-col gap-6 bg-primary-fixed/5 border-t border-primary-fixed/10 pb-12 transition-all duration-500 ${
          isOpen ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
        }`}>
          <div className="flex flex-col gap-2">
            <div className="font-headline-md text-headline-md text-primary-fixed">Neighborhood Association</div>
            <div className="font-label-md text-label-md text-primary-fixed-dim">Sabadell's Industrial Heart</div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mt-2">
            <a className="font-label-sm text-label-sm text-primary-fixed-dim opacity-70 hover:opacity-100 transition-opacity" href="#">Privacy Policy</a>
            <a className="font-label-sm text-label-sm text-primary-fixed-dim opacity-70 hover:opacity-100 transition-opacity" href="#">Archive</a>
          </div>
        </div>
      </div>

      {/* Decorative Industrial Element (Floating Gear) */}
      <div className="fixed -bottom-20 -right-20 opacity-5 pointer-events-none select-none text-primary" style={{ fontSize: '320px', zIndex: -1 }}>
        <span className="material-symbols-outlined" style={{ fontSize: '320px' }}>settings</span>
      </div>
    </>
  );
}
